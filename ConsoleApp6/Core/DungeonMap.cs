    ...
    public class DungeonMap : Map
    {
        ...
        public void OpenDoor(Actor actor, int x, int y)
        {
            ...
            if(door != null && !door.IsOpen)
            {
                ...
                Game.MessageLog.Add($"{actor.Name} opened the door.");
            }
        }
        ...
        {
            return _monsters.FirstOrDefault(mbox => mbox.X == x && mbox.Y == y);
        }
        ...
        public void AddShopkeeper(Shopkeeper shopkeep)
        {
            Game.shopkeep = shopkeep;
            SetIsWalkable(shopkeep.X, shopkeep.Y, false);
            Game.SchedulingSystem.Add(shopkeep);
        }
