...
using ConsoleApp6.Monsters;
using System.Collections.Generic;

namespace ConsoleApp6.Systems
{
    public class MapGenerator
    {
        ...
        public void CreateDoors(Rectangle room)
        {
            int xMin = room.Left;
            int xMax = room.Right;
            int yMin = room.Top;
            ...
            List<ICell> borderCells = _map.GetCellsAlongLine(xMin, yMin, xMax, yMax).ToList();
        ...
        private void PlaceBossMonster()
        {
            var monster = KoboldBoss.Create(2);
            monster.X = _map.Rooms.Last().Center.X;
            monster.Y = _map.Rooms.Last().Center.Y;
            _map.AddMonster(monster);
        }
